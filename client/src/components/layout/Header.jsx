...
const featureLinks = [
  ...
  { path: '/bug-detection', label: 'Bug Detection' },
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link to="/workspace" className={`nav-link px-3 py-1.5 rounded-lg text-sm transition-all hover:bg-[var(--glow-cyan)] ${location.pathname.startsWith('/workspace') ? 'active' : ''}`}>
              Workspace
            </Link>
            {user && (
            ...
            {user && (
              <Link to="/settings" className={`nav-link px-3 py-1.5 rounded-lg text-sm transition-all hover:bg-[var(--glow-cyan)] ${location.pathname.startsWith('/settings') ? 'active' : ''}`}>
                Settings
              </Link>
            )}
          </nav>
