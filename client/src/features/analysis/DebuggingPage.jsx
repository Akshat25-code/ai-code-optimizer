          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(20, 184, 166, 0.1) 100%)', border: `1px solid var(--card-border)` }}>
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold" style={{ color: 'var(--fg-color)' }}>ðŸ”§ Debugging Results</h2>
                ...
                >
                  {copied ? 'âœ“ Copied' : 'ðŸ“‹ Copy Fixed Code'}
                </button>
              </div>
            </div>
          </div>
            ...
            >
              <div className="px-4 py-3 flex items-center justify-between" style={{ borderBottom: `1px solid var(--card-border)` }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {optimizer.isRunning ? 'Runningâ€¦' : 'â–¶ï¸ Run'}
                  </button>
                </div>
              </div>
              <div className="h-64">
            ...
            >
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-center gap-4 text-sm text-muted">
                  <span>â±ï¸ Time: {optimizer.runResult.exec_time_ms}ms</span>
                  {optimizer.runResult.peak_kb && <span>ðŸ’¾ Memory: {optimizer.runResult.peak_kb}KB</span>}
                </div>
