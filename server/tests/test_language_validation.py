...
def test_valid_languages():
    ...
    from models.requests import validate_programming_language
...
def test_auto_correct():
    ...
    for alias in ["py", "js", "ts", "cpp"]:
        try:
            ...
            pass  # Some aliases may not be supported â€” that's fine


def test_supported_languages_list():
    """Test that the supported languages list is comprehensive."""
    from models.requests import get_supported_languages
...
def test_popular_languages_list():
    ...
    from models.requests import get_popular_languages
